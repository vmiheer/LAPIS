...
A = pt.tensor([5, 5], [pt.compressed, pt.dense], dtype=pt.float64)
...
shutil.copyfile("lapis_package/lapis_package_module.cpp", "lapis_package/lapis_package_module_4.cpp")
