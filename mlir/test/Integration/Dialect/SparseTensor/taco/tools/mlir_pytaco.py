...
class Tensor:
    ...
    def to_file_kokkos(self, filename: str, options: str = "", index_instance=0, num_instances=0) -> None:
    ...
    def compile_kokkos(self, force_recompile: bool = False,
                       options: str = "", index_instance: int = 0, num_instances: int = 0) -> None:
        ...
        self._engine_kokkos = self._assignment.expression.compile_kokkos(self,
                                                           ...
                                                           index_instance=index_instance, num_instances=num_instances)
